        ...
        <div className="row my-5 g-2">
          <div style={{ height: "250px" }} className="col-md-6">
            <div className="card h-100">
              <img
                src="https://images.unsplash.com/photo-1485291571150-772bcfc10da5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTR8fGNhcnxlbnwwfDB8MHx8&auto=format&fit=crop&w=500&q=60"
                ...
                return (
                  <div className="col-md-4 my-3">
                    <div className="card h-100">
                      ...
                      >
                        <img
                          src={ImageUrl(car.carImages[0].img)}
                          className="card-img-top h-75 w-50 mt-3"
                          alt="..."
                        />
                      </div>
                      <div className="card-body">
                        ...
                        <div className="row">
                          <h5 className="card-title text-start fw-bold text-dark col-md-6">
                            {car.name}
                          </h5>
                          <h6 className="card-title text-end text-primary fw-bold col-md-6">
                            From PKR {car.price}
                          </h6>
                        </div>
                      </div>
